const ListSelector = function (BaseObject) {
	"use strict";

	const extBaseObject = BaseObject.extend("sap.ui.demo.masterdetail.model.ListSelector", {
...
export default () => new Promise((resolve) => sap.ui.define([
	"sap/ui/base/Object"
], (BaseObject) =>
	resolve(ListSelector(BaseObject))
))
