...
var _ListSelectorNew = __webpack_require__(76);
...
"sap/ui/demo/masterdetail/controller/ErrorHandler"], function (UIComponent, Device, models, ErrorHandler) {
   ...
   */
		init: function init() {
			...
			this.oListSelector = new _promise2.default(function () {
...
var ListSelector = function ListSelector(BaseObject) {
	"use strict";

	var extBaseObject = BaseObject.extend("sap.ui.demo.masterdetail.model.ListSelector", {
   ...
   */
		...
		constructor: function constructor() {
			this._oWhenListHasBeenSet = new _promise2.default(function (fnResolveListHasBeenSet) {
				this._fnResolveListHasBeenSet = fnResolveListHasBeenSet;
			}.bind(this));
			// This promise needs to be created in the constructor, since it is allowed to
			// invoke selectItem functions before calling setBoundMasterList
			this.oWhenListLoadingIsDone = new _promise2.default(function (fnResolve, fnReject) {
   ...
   * @public
   */
		setBoundMasterList: function setBoundMasterList(oList) {
			this._oList = oList;
   ...
   * @public
   */
		selectAListItem: function selectAListItem(sBindingPath) {
   ...
   * @public
   */
		attachListSelectionChange: function attachListSelectionChange(fnFunction, oListener) {
   ...
   * @public
   */
		detachListSelectionChange: function detachListSelectionChange(fnFunction, oListener) {
			this._oWhenListHasBeenSet.then(function () {
   ...
   * @public
   */
		clearMasterListSelection: function clearMasterListSelection() {
	...
	return extBaseObject;
	// return new extBaseObject();
};
...
// sap.ui.define Promise Wrapper

exports.default = function () {
	return new _promise2.default(function (resolve) {
		return sap.ui.define(["sap/ui/base/Object"], function (BaseObject) {
			return resolve(ListSelector(BaseObject));
		});
	});
};
